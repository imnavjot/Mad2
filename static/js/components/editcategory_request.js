...
const EditCategoryRequest = Vue.component("editcategoryrequest", {
  props: ["category_id"],
  template: `
    <div>
      <!-- Navigation Bar -->
      <nav class="navbar navbar-light bg-light sticky-top">
        <div class="container">
          <a class="navbar-brand">Grocery Store - Edit Category Request</a>
  ...
  methods: {
    editCategory() {
      ...
      fetch(`/store_manager/edit_category_request/${this.category_id}`, {
        method: 'PUT',
        headers: {
